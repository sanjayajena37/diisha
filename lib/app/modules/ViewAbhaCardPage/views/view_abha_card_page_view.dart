...
class ViewAbhaCardPageView extends GetView<ViewAbhaCardPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<ViewAbhaCardPageController>(
            id: "abhaCard",
          builder: (context) {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                            height: ( Get.height - Get.statusBarHeight- Get.bottomBarHeight)*0.05,
                            width: 100,
                 ...
                 Padding(
                   ...
                   child: Container(
                     ...
                     height:( Get.height - Get.statusBarHeight- Get.bottomBarHeight)*0.37,
                   ...
                   child: Card(
                     child: Padding(
                       ...
                       child: Container(
                         ...
                         height:( Get.height - Get.statusBarHeight- Get.bottomBarHeight)*0.412,
                         width: double.maxFinite,
                             ...
                             child: Column(
                               children: [
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     Image.asset("assets/images/abhacard.jpg",height: 90,width: Get.width*0.2,),
                                     Container(
